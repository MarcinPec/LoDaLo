english_words = [
    ...
    "fish", "five", "floor", "fly", "focus", "follow", "food", "foot", "force", "foreign",
    ...
    "guess", "gun", "hair", "half", "hand", "hang", "happen", "happy", "hard", "have",
    ...
    "husband", "idea", "identify", "if", "image", "imagine", "impact", "important", "improve", "include",
    "including", "increase", "indeed", "individual", "industry", "information", "inside", "instead", "institution", "interest",
    ...
    "lawyer", "lay", "lead", "leader", "learn", "least", "leave", "left", "legal", "less",
    ...
    "not", "note", "nothing", "notice", "now", "n't", "number", "occur", "of", "off",
