...
import assoc_bigram_genpass_engine, ai_password_analizer_engine
...
class AssocPassGener(UserControl):
    def __init__(self):
        ...
        self.length = ft.TextField(label='Length', border_color='#00CCFF', text_style=self.reg_cell_style)
